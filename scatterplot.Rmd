...
```{r}
# Scatter plot for Legionella pneumophila
...
# Plot the normalized data with log scale as scatter plot
ggplot(filtered_data, aes(x = factor(site_code), y = normalized_count)) +
...
```
```{r}
# scatter plot for longbeachae

setwd("/Users/pchhyun/Documents/legionella/")
# Read the data
data <- read.table("mergedsampleppspecies.tsv", header = TRUE, sep = "\t")
